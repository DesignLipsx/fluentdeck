...
export const IconDetailView: React.FC<{
	...
	return (
			...
			headerActions={
				<div className="flex items-center gap-2">
					...
					<button
						...
						className="p-1 rounded-full text-text-secondary hover:bg-bg-active transition"
		...
		>
			<div
				className="flex flex-col gap-6 lg:gap-8 lg:flex-row overflow-visible"
				style={{
			...
			>
				...
				<div className="w-full lg:w-[var(--preview-w)] flex-shrink-0">
					...
					{/* Preview */}
					<div className="flex flex-col items-center justify-center p-4 rounded-xl bg-bg-primary border border-border-primary h-64 lg:h-80 relative flex-shrink-0 max-w-full">
						...
						/>
						<div className="relative z-10 flex items-center justify-center text-text-primary">
							{isLoading && !svgContent ? (
								<div className="w-8 h-8 border-2 border-border-primary border-t-blue-500 rounded-full animate-spin" />
							) : (
								svgContent && (
				...
				{selectedStyle !== "Color" && (
					<div className="w-full lg:w-[var(--color-w)] flex-shrink-0 lg:h-[22rem] mt-6 lg:mt-0">
				...
				{/* 3. EXPORT OPTIONS */}
				<div className="w-full lg:flex-1 lg:min-w-0 flex flex-col mt-6 lg:mt-0">
					{/* Title */}
					<h3 className="text-sm font-semibold text-text-primary uppercase tracking-wide mb-4">
						Export Options
					</h3>
					...
					<div className="flex-1 flex flex-col justify-between space-y-2">
						<ActionRow
							...
							icon={<SvgIcon className="w-5 h-5 text-text-primary" />}
						/>
						...
						<ActionRow
							...
							icon={<HtmlIcon className="w-5 h-5 text-text-primary" />}
						/>
						...
						<ActionRow
							...
							icon={<ReactIcon className="w-5 h-5 text-text-primary" />}
						/>
						...
						<ActionRow
							...
							icon={<VueIcon className="w-5 h-5 text-text-primary" />}
						/>
					</div>
				</div>
			</div>
