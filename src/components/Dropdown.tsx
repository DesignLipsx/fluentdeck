...
export const DropdownMenu: React.FC<DropdownMenuProps> = ({ children, trigger, direction = 'down', menuClassName = '', onOpen }) => {
  ...
  const baseDropdownClasses = `absolute rounded-lg shadow-lg bg-bg-secondary border border-border-primary focus:outline-none z-50 p-1 ${originClass} ${positionClass} ${menuClassName}`;
