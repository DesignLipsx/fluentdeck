...
import { AddIcon, CheckmarkIcon } from '@/components/Icons';
		...
		return (
			<div ref={ref} className="relative flex items-center">
				<button
					...
					className="p-1 rounded-full text-text-secondary hover:bg-bg-active"
				...
				{isMenuOpen && (
					<div
						ref={menuRef}
						className="absolute right-0 top-full mt-2 z-50 w-48 rounded-md shadow-lg bg-bg-secondary border border-border-primary focus:outline-none p-1 animate-scaleIn origin-top-right"
						role="menu"
						aria-orientation="vertical"
					>
						<p className="px-3 py-1 text-xs font-semibold text-text-secondary uppercase">
							Add to Collection
						</p>
